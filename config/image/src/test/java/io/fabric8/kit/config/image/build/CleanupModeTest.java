...
import static io.fabric8.kit.config.image.build.CleanupMode.NONE;
import static io.fabric8.kit.config.image.build.CleanupMode.REMOVE;
import static io.fabric8.kit.config.image.build.CleanupMode.TRY_TO_REMOVE;
