...
public class FatJarDetector {
    ...
    FatJarDetector(File dir) {
        this.directory = dir;
    }

    Result scan() throws Fabric8ExecutionException {
        // Scanning is lazy ...
        if (result == null) {
            if (!directory.exists()) {
            ...
            for (String jarOrWar : jarOrWars) {
                ...
                try {
                    ...
                    throw new Fabric8ExecutionException("Cannot examine file " + archiveFile + " for the manifest");
                }
            }
        }
        return result;
