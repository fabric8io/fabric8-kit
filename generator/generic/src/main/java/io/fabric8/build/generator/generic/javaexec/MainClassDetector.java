...
class MainClassDetector {
    ...
    MainClassDetector(String mainClass, File classesDir, BuildLogger log) {
    ...
    String getMainClass() {
        ...
        try {
            List<String> foundMainClasses = Collections.emptyList(); // TODO FIXME port ClassUtil.findMainClasses(classesDir);
